...
?>
    ...
    <div class="container-fluid text-center mb-5">
        ...
        <p>Berikut kami sajikan daftar beasiswa yang diselenggarakan oleh pemerintah :</p>
    </div>
            ...
            <div class="col">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <a href="programindonesiapintar.php" class="btn btn-success" target="_self" >Baca
                            Selengkapnya</a>
                    </div>
                </div>
            </div>
